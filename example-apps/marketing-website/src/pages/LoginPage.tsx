  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isSignUp) {
        ...
        toast({ title: 'Account created!', description: 'Welcome to Strata Storage.', variant: 'success' });
      } else {
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>
              {isSignUp ? 'Sign up to submit feedback and reviews' : 'Sign in to your account'}
            </CardDescription>
          </CardHeader>
          <CardContent>
