...
async function basicUsageExample() {
  ...
  // Tags set via options are record metadata — query() can't see them. Use them
  // for bulk operations like clearing everything tagged 'config':
  // await storage.clear({ tags: ['config'] });
